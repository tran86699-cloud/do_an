...
def ai_chat():
    ...
    try:
        ...
        image_data = data.get('image', None)  # ✅ GET IMAGE
        ...
        if image_data:
            ...
            print(f"[AI-CHAT] No image")  # ← Should NOT see this for vision queries!
...
def index():
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            if all(status == "✅" for status in models_status.values()):
                vision_status = "✅ Yes (All 3 models)"
    except:
        pass
    ...
    <body>
        <h1>🧠🔀 PC SERVER - SEMANTIC ROUTER (Graduation Project)</h1>
        ...
        <div class="status">
            ...
            <!-- <div class="model-item">  {models_status.get('vision_backup', '❓')} <code>{MODELS.get('vision_backup', 'N/A')}</code> - Vision Backup</div> -->
